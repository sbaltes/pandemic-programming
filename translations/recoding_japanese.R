...
map_agreement_helpful <- function() {
  ...
  true <- match_str('行っている')
  helpful <- match_str('役に立つ')
...
covid_response_mapping <- "'どのような理由であっても、私は全く外出していない。'=3; '必要な用事（食料品確保、医療、運動など）のためだけに外出している。'=2; '仕事や娯楽のために定期的に外出している。他人と距離を置くよう心がけている。'=1; '定期的に外出している。他人と距離を置くことは特に注意していない。'=0; else=NA"
yes_no_maybe_mapping <- "'はい'=1; 'まあそう思う/わからない'=0; 'いいえ'=-1; else=NA"
likert_scale_mapping_1 <- "'とてもそう思う'=4; 'まあそう思う'=3; 'どちらとも言えない'=2; 'あまりそう思わない'=1; 'まったくそう思わない'=0; 'わからない/該当しない'=-99; else=NA"
likert_scale_mapping_2 <- "'とてもそう思う'=3; 'そう思う'=2; 'まあそう思う'=1; 'あまりそう思わない'=-1; 'そう思わない'=-2; 'まったくそう思わない'=-3; else=NA"
frequency_mapping_1 <- "'いつも'=5; 'ほとんど'=4; '半分以上'=3; '半分以下'=2; 'たまに'=1; 'なかった'=0; 'ない'=0; else=NA"
frequency_mapping_2 <- "'いつも'=4; 'ほとんど'=3; 'ときどき'=2; 'たまに'=1; 'なかった'=0; 'ない'=0; else=NA"
performance_mapping <- "'他の労働者よりもずっと優秀だった'=3; '他の労働者よりもある程度優秀だった'=2; '他の労働者よりも少し優秀だった'=1; '平均的だった'=0; '他の労働者よりも少し劣っていた'=-1; '他の労働者よりもある程度劣っていた'=-2; '他の労働者よりもずっと劣っていた'=-3; else=NA"
age_mapping <- "'19歳以下'=1; '20-24'=2; '25-29'=3; '30-34'=4; '35-39'=5; '40-44'=6; '45-49'=7; '50-54'=8; '55-59'=9; '60-64'=10; '65歳以上'=11; else=NA"
gender_mapping <- "'女性'='Female'; '男性'='Male'; 'ノンバイナリージェンダー/第三の性'='NB'; 'Other'='Other'; else=NA"
education_mapping <- "'博士課程（博士後期課程）修了、それに類するもの'=4; '修士課程（博士前期課程）修了、それに類するもの'=3; '学部卒業、それに類するもの'=2; '高等学校卒業、それに類するもの'=1; '中学校卒業、それに類するもの'=0; else=NA"
organization_size_mapping <- "'0 から 9'=1; '10 から 99'=2; '100 から 999'=3; '1000 から 9999'=4; '10,000 から 99,999'=5; '100,000 以上'=6; else=NA"
disability_mapping <- "'はい'=2; 'おそらく'=1; 'いいえ'=0; else=NA"
...
filtered$COVIDStatus5 <- as.integer(match_str("自身に陽性反応が出た。"))
filtered$COVIDStatus4 <- as.integer(match_str("自宅で自分以外に陽性反応が出た。"))
filtered$COVIDStatus3 <- as.integer(match_str("家族の中で陽性反応が出た。"))
filtered$COVIDStatus2 <- as.integer(match_str("親しい友人に陽性反応が出た。"))
filtered$COVIDStatus1 <- as.integer(match_str("現在、または最近隔離されている（何らかの理由で家を出てはいけないという指示を受けている）。"))
filtered$COVIDStatus0 <- as.integer(match_str("上記のいずれにも該当しない。"))
